...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;">mulagi Cafe</h1></center>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Join mulagi  Cafe</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="input-group">
						...
						<input id="posts" type="posts" class="form-control" placeholder="post" name="u_post" required="required">
					</div><br>
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-heart"></i></span>
						<select class="form-control input-md" name="u_Relationship" required="required">
					...
					<div class="input-group">
						...
						<input id="describe_user" type="describe_user" class="form-control" placeholder="describe yourself bruv" name="u_describe" required="required">
					</div><br>
					<div class="input-group">
