...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$area = htmlentities(mysqli_real_escape_string($con,$_POST['u_area']));
		$gender = htmlentities(mysqli_real_escape_string($con,$_POST['u_gender']));
        $birthday = htmlentities(mysqli_real_escape_string($con,$_POST['u_birthday']));
        $des_user = htmlentities(mysqli_real_escape_string($con,$_POST['u_describe']));
		$status = "verified";
		$posts = "no";
		...
		values('$first_name','$last_name','$username','$des_user','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
